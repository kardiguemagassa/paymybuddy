DROP DATABASE IF EXISTS `openclassrooms_paymybuddy_test`;
CREATE DATABASE IF NOT EXISTS `openclassrooms_paymybuddy_test` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `openclassrooms_paymybuddy_test`;
